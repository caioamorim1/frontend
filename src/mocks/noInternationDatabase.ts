...
const sector1: SectorAssistance = {
    ...
    descr: 'Setor responsável pela realização de procedimentos cirúrgicos programados e de emergência.',
    costAmount: 2500000,
...
const sector2: SectorAssistance = {
    ...
    descr: 'Responsável pelo processamento, limpeza, esterilização e distribuição de todos os materiais médicos.',
    costAmount: 450000,
...
const sector3: SectorAssistance = {
    id: '103',
    name: 'Ambulatório',
    descr: 'Oferece consultas agendadas, exames e pequenos procedimentos que não necessitam de internação.',
    costAmount: 1200000,
