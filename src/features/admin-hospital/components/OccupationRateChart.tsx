...
const barConfig = [
    ...
    { key: 'Capacidade Produtiva', color: 'hsl(193, 85%, 29%)' }, // --secondary
    { key: 'Ociosidade', color: 'hsl(206, 100%, 36%)' },        // Tom mais claro de azul
    { key: 'Superlotação', color: 'hsl(206, 100%, 66%)' }         // Tom mais claro ainda
];
    ...
    <Card className="col-span-1 lg:col-span-2">
      <CardHeader className="flex flex-row items-start justify-between">
        <div>
            ...
            <CardDescription>Análise comparativa de ocupação, ociosidade e superlotação.</CardDescription>
        </div>
