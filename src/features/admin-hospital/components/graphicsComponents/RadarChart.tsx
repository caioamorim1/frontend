            ...
            <CardContent>
                <ResponsiveContainer width="100%" height={350}>
                    <RadarChart cx="50%" cy="50%" outerRadius="80%" data={data}>
                        ...
                        <Radar name="Atual" dataKey="atual" stroke="#4169E1" fill="#4169E1" fillOpacity={0.2} />
                        <Radar name="Projetado" dataKey="projetado" stroke="#FF8C00" fill="#FF8C00" fillOpacity={0.2} />
                        <Legend />
                    </RadarChart>
                </ResponsiveContainer>
            </CardContent>
