...
import RadarChartComponent from "@/features/admin-hospital/components/graphicsComponents/RadarChart";
        ...
        <div className="space-y-8 pb-10">
            ...
            <Tabs defaultValue="baseline">
                ...
                <TabsContent value="baseline">
                    ...
                    <div className="grid grid-cols-1 gap-6 mt-6">
                        <DashboardBaselineScreen
                            title="Análise Econômico-Financeira base" />
                    </div>
                </TabsContent>
                ...
                <TabsContent value="comparativo">
                    ...
                    <div className="grid grid-cols-1 gap-6 mt-6">
                        <WaterfallChart
                            title="Análise Econômico-Financeira Detalhada"
                            globalData={waterfallGlobalData}
                            internacaoData={waterfallInternacaoData}
                            naoInternacaoData={waterfallNaoInternacaoData}
                            globalVsInternacaoData={waterfallGlobalVsInternacaoData}
                            globalVsNaoInternacaoData={waterfallGlobalVsNaoInternacaoData} />
                    </div>
                </TabsContent>
            </Tabs>
        </div>
